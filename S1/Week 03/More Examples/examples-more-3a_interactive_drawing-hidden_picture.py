...
# Just one more fun example of drawing on the canvas :) See
#	if you can figure out what the picture is!
# Note: This is also why you should comment your code to 
#	remind yourself what you are drawing.
