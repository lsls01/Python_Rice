...
# Here are some additional methods of lists that are helpful.
#	For the full list as well as further details, please
#	check the docs.

# list.append(item) adds the given item at the end of the
#	list.
...
# list.remove(item) removes the item from the list if it is
#	present, but throws an error if it is not in the list.
...
# list.index(item) returns the index of an item in a list, but
